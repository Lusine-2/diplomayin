...
I('test_result').innerHTML='<h3>Թեստն ավարտված է!</h3><strong>Հարցերի քանակ:</strong> '+q.length+'<br /><strong> Ճիշտ պատասխաններ:</strong> '+bal+'<br /><a style="border-bottom: 1px dotted; cursor: pointer;" onClick="window.location.reload(true);"> Փորձել կրկին</a>'; 
